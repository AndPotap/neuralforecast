...
__all__ = ['SinCosPosEncoding', 'Transpose', 'get_activation_fn', 'PositionalEncoding', 'Coord2dPosEncoding',
           ...
           'TSTEncoder', 'TSTEncoderLayer', 'PatchTST_Flat']
...
class PatchTST_Flat(BaseWindows):
    # Class attributes
    ...
    def forward(self, windows_batch):  # x: [batch, input_size]
        ...
        forecast = self.flat(y=insample_y, yhat=forecast, xt=hist_exog, xf=futr_exog, xs=stat_exog)
