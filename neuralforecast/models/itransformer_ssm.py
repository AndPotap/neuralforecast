...
# %% auto 0
__all__ = ['TriangularCausalMask', 'FullAttention', 'DataEmbedding_inverted', 'iTransformer_SSM']
...
class iTransformer_SSM(BaseMultivariate):
    """iTransformer
    ...
    **References**<br>
    ...
    def forward(self, windows_batch):
        ...
        # else:
        #     return y_pred
        xf = futr_exog[:, :, :, 0].transpose(-1, -2)
        forecast = self.ssm(y=insample_y[:, :, 0], yhat=y_pred, xt=hist_exog, xf=xf, xs=stat_exog)
